...
| Audit export | Note view/edit/sign/print/letter + patient prep access via Settings |
| Clinical correspondence | Print signed note (browser PDF) and editable GP letter drafted from signed sections |
