...
export const SAAS_PLANS = [
  {
    ...
    priceLabel: "£79",
    period: "/ month",
    blurb: "Solo or small practice — diary, notes, online booking.",
  ...
  },
  {
    ...
    priceLabel: "£149",
    period: "/ month",
    blurb: "Multi-practitioner clinic with rooms, waitlist, and staff pay.",
  ...
  },
  {
    ...
    period: "",
    blurb: "Multi-site groups, custom onboarding, and SLA support.",
