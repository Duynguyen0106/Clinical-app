...
export const SAAS_PLANS = [
  {
    ...
    priceLabel: "£79",
    period: "/ month",
    blurb: "Full clinic management — diary, clinical notes, online booking, and invoices.",
  ...
  },
  {
    ...
    priceLabel: "£149",
    period: "/ month",
    blurb: "The complete practice system — rooms, waitlist, staff pay, team leave, priority help.",
  ...
  },
  {
    ...
    period: "",
    blurb: "Multi-site clinic groups with guided rollout and SLA support.",
